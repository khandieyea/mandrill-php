...
class Rejects {
     ...
     * @return array a status object containing the address and the result of the operation
     ...
     *
     * There is no limit to how many rejections
     ...
     * @return array a status object containing the address and whether the deletion succeeded.
