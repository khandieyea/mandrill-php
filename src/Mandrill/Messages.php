...
class Messages {
     ...
     */
    public function send(array $message, bool $async=false, $ip_pool=null, $send_at=null): array {
     ...
     * @param array $message the other information on the message to send - same as /messages/send, but without the html content
     ...
     *         - _id string the message's unique id
     */
    public function sendTemplate(string $template_name, array $template_content, array $message, bool $async=false, $ip_pool=null, $send_at=null): array {
     ...
     */
    public function search(string $query='*', $date_from=null, $date_to=null, $tags=null, $senders=null, $api_keys=null, int $limit=100): array {
     ...
     */
    public function searchTimeSeries(string $query='*', $date_from=null, $date_to=null, $tags=null, $senders=null): array {
     ...
     * @return array the information for the message
     *     - ts integer the Unix timestamp from when this message was sent
     *     - _id string the message's unique id
     *     - sender string the email address of the sender
     *     - template string the unique name of the template used, if any
     ...
     * @param string $id the unique id of the message to get - passed as the "_id" field in webhooks, send calls, or search calls
     * @return array the content of the message
     *     - ts integer the Unix timestamp from when this message was sent
     *     - _id string the message's unique id
     ...
     * @return array the parsed message
     ...
     *             - content string the content of the image as a base64 encoded string
     */
    public function parse(string $raw_message): array {
     ...
     *         - _id string the message's unique id
     */
    public function sendRaw(string $raw_message, $from_email=null, $from_name=null, $to=null, $async=false, $ip_pool=null, $send_at=null, $return_path_domain=null): array {
     ...
     */
    public function listScheduled($to=null): array {
        $_params = array("to" => $to);
     ...
     * @return array information about the scheduled email that was cancelled.
     *     - _id string the scheduled message id
     *     - created_at string the UTC timestamp when the message was created, in YYYY-MM-DD HH:MM:SS format
     *     - send_at string the UTC timestamp when the message will be sent, in YYYY-MM-DD HH:MM:SS format
     *     - from_email string the email's sender address
     ...
     * @return array information about the scheduled email that was rescheduled.
     *     - _id string the scheduled message id
     *     - created_at string the UTC timestamp when the message was created, in YYYY-MM-DD HH:MM:SS format
     *     - send_at string the UTC timestamp when the message will be sent, in YYYY-MM-DD HH:MM:SS format
     *     - from_email string the email's sender address
     ...
     *     - subject string the email's subject
     */
    public function reschedule(string $id, string $send_at): array {
